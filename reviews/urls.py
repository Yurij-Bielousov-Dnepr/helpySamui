...
from .views import (
    ...
    review_edit,
    review_list_helper,
    review_detail, review_helper_edit, ReviewHelperEdit, ReviewCreateArt_Event, like,
)
...
urlpatterns = [
    ...
    path("reviews/moderate/",
        staff_member_required(ModerateReview.as_view()), name="moderation_view", ),
    path("<int:pk>/", review_detail, name="review_detail"),
    path("add/", ReviewCreateView.as_view(), name="reviews_add"),
    path("<int:pk>/edit/", ReviewHelperEdit.as_view(), name="review_edit"),
